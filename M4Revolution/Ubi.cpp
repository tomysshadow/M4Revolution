...
Ubi::BigFile::File::File(std::ifstream &inputFileStream, File::SIZE &filesPosition, bool texture) {
...
Ubi::BigFile::Header::Header(std::ifstream &inputFileStream, File::SIZE &filesPosition) {
	read(inputFileStream);
