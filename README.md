...
12. Copy the **x86** Debug GetDLLExportRVA.exe to `x64/Debug`. Notice that the **x86** build must be copied to the **x64** Debug folder.
13. Copy the **x86** Release GetDLLExportRVA.exe to `x64/Release`. Notice that the **x86** build must be copied to the **x64** Release folder.
